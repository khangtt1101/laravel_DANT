    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width:640px;margin:0 auto;background:#ffffff;border-radius:12px;padding:32px;border:1px solid #e2e8f0;">
        <tr>
            <td>
                ...
                <p style="margin:0 0 12px 0;">Bạn nhận được một yêu cầu mới từ website PolyTech Store.</p>
                ...
                <div style="margin-bottom:24px;">
                    ...
                    <p style="margin:6px 0;"><strong>Thời gian gửi:</strong> {{ $contactRequest->created_at->format('d/m/Y H:i') }}</p>
                </div>
                ...
                <p style="margin-top:24px;font-size:12px;color:#64748b;">Email được gửi tự động từ hệ thống. Vui lòng trả lời trực tiếp cho khách hàng qua email ở trên.</p>
            </td>
        </tr>
    </table>
</body>
