<header class="bg-white shadow-md sticky top-0 z-50">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-12">
                ...
                <div class="hidden lg:flex items-center gap-6">
                    ...
                    <a href="#" class="hover:text-indigo-200 transition text-sm font-medium">Sản phẩm</a>
    ...
    <div x-show="mobileMenuOpen" @click.away="mobileMenuOpen = false" class="md:hidden bg-white border-t shadow-lg" x-transition>
        <div class="px-4 py-4 space-y-3">
            ...
            <a href="#" class="block px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-indigo-50 hover:text-indigo-600 transition">Sản phẩm</a>
